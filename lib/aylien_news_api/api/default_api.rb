...
module AylienNewsApi
  class DefaultApi
    ...
    # @option opts [Array<String>] :entities_surface_forms_text2 This parameter is used to exclude stories based on the specified entity&#39;s &#x60;surface_form&#x60;. You can read more about working with entities [here](https://newsapi.aylien.com/docs/working-with-entities). 
    ...
    def list_histograms_with_http_info(opts = {})
      ...
      query_params[:'entities.id[]'] = @api_client.build_collection_param(opts[:'entities_id'], :multi) if !opts[:'entities_id'].nil?
      query_params[:'!entities.id[]'] = @api_client.build_collection_param(opts[:'entities_id2'], :multi) if !opts[:'entities_id2'].nil?
      query_params[:'entities.links.wikipedia[]'] = @api_client.build_collection_param(opts[:'entities_links_wikipedia'], :multi) if !opts[:'entities_links_wikipedia'].nil?
      query_params[:'!entities.links.wikipedia[]'] = @api_client.build_collection_param(opts[:'entities_links_wikipedia2'], :multi) if !opts[:'entities_links_wikipedia2'].nil?
      query_params[:'entities.links.wikidata[]'] = @api_client.build_collection_param(opts[:'entities_links_wikidata'], :multi) if !opts[:'entities_links_wikidata'].nil?
      query_params[:'!entities.links.wikidata[]'] = @api_client.build_collection_param(opts[:'entities_links_wikidata2'], :multi) if !opts[:'entities_links_wikidata2'].nil?
      query_params[:'entities.types[]'] = @api_client.build_collection_param(opts[:'entities_types'], :multi) if !opts[:'entities_types'].nil?
      query_params[:'!entities.types[]'] = @api_client.build_collection_param(opts[:'entities_types2'], :multi) if !opts[:'entities_types2'].nil?
      query_params[:'entities.stock_tickers[]'] = @api_client.build_collection_param(opts[:'entities_stock_tickers'], :multi) if !opts[:'entities_stock_tickers'].nil?
      query_params[:'!entities.body.stock_tickers[]'] = @api_client.build_collection_param(opts[:'entities_body_stock_tickers'], :multi) if !opts[:'entities_body_stock_tickers'].nil?
      query_params[:'entities.surface_forms.text[]'] = @api_client.build_collection_param(opts[:'entities_surface_forms_text'], :multi) if !opts[:'entities_surface_forms_text'].nil?
      query_params[:'!entities.surface_forms.text[]'] = @api_client.build_collection_param(opts[:'entities_surface_forms_text2'], :multi) if !opts[:'entities_surface_forms_text2'].nil?
      ...
      query_params[:'!entities.title.surface_forms.text[]'] = @api_client.build_collection_param(opts[:'entities_title_surface_forms_text2'], :multi) if !opts[:'entities_title_surface_forms_text2'].nil?
      query_params[:'entities.body.surface_forms.text[]'] = @api_client.build_collection_param(opts[:'entities_body_surface_forms_text'], :multi) if !opts[:'entities_body_surface_forms_text'].nil?
      query_params[:'!entities.body.surface_forms.text[]'] = @api_client.build_collection_param(opts[:'entities_body_surface_forms_text2'], :multi) if !opts[:'entities_body_surface_forms_text2'].nil?
