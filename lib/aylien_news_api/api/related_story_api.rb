  ...
  class RelatedStoryApi
    ...
    def list_related_stories_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RelatedStoryApi.list_related_stories_get ...'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'media_images_count_min'].nil? && opts[:'media_images_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_count_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_count_max'].nil? && opts[:'media_images_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_count_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_width_min'].nil? && opts[:'media_images_width_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_width_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_width_max'].nil? && opts[:'media_images_width_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_width_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_height_min'].nil? && opts[:'media_images_height_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_height_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_height_max'].nil? && opts[:'media_images_height_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_height_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'media_images_content_length_min'].nil? && opts[:'media_images_content_length_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_content_length_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'media_images_content_length_max'].nil? && opts[:'media_images_content_length_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_content_length_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'media_videos_count_min'].nil? && opts[:'media_videos_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_videos_count_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_videos_count_max'].nil? && opts[:'media_videos_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_videos_count_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'source_links_in_count_min'].nil? && opts[:'source_links_in_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_links_in_count_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'source_links_in_count_max'].nil? && opts[:'source_links_in_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_links_in_count_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'source_rankings_alexa_rank_min'].nil? && opts[:'source_rankings_alexa_rank_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_rankings_alexa_rank_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'source_rankings_alexa_rank_max'].nil? && opts[:'source_rankings_alexa_rank_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_rankings_alexa_rank_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_facebook_min'].nil? && opts[:'social_shares_count_facebook_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_facebook_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_facebook_max'].nil? && opts[:'social_shares_count_facebook_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_facebook_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_google_plus_min'].nil? && opts[:'social_shares_count_google_plus_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_google_plus_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_google_plus_max'].nil? && opts[:'social_shares_count_google_plus_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_google_plus_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_linkedin_min'].nil? && opts[:'social_shares_count_linkedin_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_linkedin_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_linkedin_max'].nil? && opts[:'social_shares_count_linkedin_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_linkedin_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_reddit_min'].nil? && opts[:'social_shares_count_reddit_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_reddit_min"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'social_shares_count_reddit_max'].nil? && opts[:'social_shares_count_reddit_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_reddit_max"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling RelatedStoryApi.list_related_stories_get, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling RelatedStoryApi.list_related_stories_get, must be greater than or equal to 1.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RelatedStoryApi#list_related_stories_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def list_related_stories_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: RelatedStoryApi.list_related_stories_post ...'
      end
      allowable_values = ["en", "de", "fr", "it", "es", "pt"]
      if @api_client.config.client_side_validation && opts[:'language'] && !opts[:'language'].all? { |item| allowable_values.include?(item) }
        fail ArgumentError, "invalid value for \"language\", must include one of #{allowable_values}"
      ...
      if @api_client.config.client_side_validation && !opts[:'media_images_count_min'].nil? && opts[:'media_images_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_count_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_count_max'].nil? && opts[:'media_images_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_count_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_width_min'].nil? && opts[:'media_images_width_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_width_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_width_max'].nil? && opts[:'media_images_width_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_width_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_height_min'].nil? && opts[:'media_images_height_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_height_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_height_max'].nil? && opts[:'media_images_height_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_height_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_content_length_min'].nil? && opts[:'media_images_content_length_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_content_length_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_images_content_length_max'].nil? && opts[:'media_images_content_length_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_images_content_length_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'media_videos_count_min'].nil? && opts[:'media_videos_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_videos_count_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'media_videos_count_max'].nil? && opts[:'media_videos_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"media_videos_count_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'source_links_in_count_min'].nil? && opts[:'source_links_in_count_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_links_in_count_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'source_links_in_count_max'].nil? && opts[:'source_links_in_count_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_links_in_count_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'source_rankings_alexa_rank_min'].nil? && opts[:'source_rankings_alexa_rank_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_rankings_alexa_rank_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'source_rankings_alexa_rank_max'].nil? && opts[:'source_rankings_alexa_rank_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"source_rankings_alexa_rank_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_facebook_min'].nil? && opts[:'social_shares_count_facebook_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_facebook_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_facebook_max'].nil? && opts[:'social_shares_count_facebook_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_facebook_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_google_plus_min'].nil? && opts[:'social_shares_count_google_plus_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_google_plus_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_google_plus_max'].nil? && opts[:'social_shares_count_google_plus_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_google_plus_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_linkedin_min'].nil? && opts[:'social_shares_count_linkedin_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_linkedin_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_linkedin_max'].nil? && opts[:'social_shares_count_linkedin_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_linkedin_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_reddit_min'].nil? && opts[:'social_shares_count_reddit_min'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_reddit_min"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'social_shares_count_reddit_max'].nil? && opts[:'social_shares_count_reddit_max'] <= 0
        fail ArgumentError, 'invalid value for "opts[:"social_shares_count_reddit_max"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] > 100
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling RelatedStoryApi.list_related_stories_post, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'per_page'].nil? && opts[:'per_page'] < 1
        fail ArgumentError, 'invalid value for "opts[:"per_page"]" when calling RelatedStoryApi.list_related_stories_post, must be greater than or equal to 1.'
      end
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: RelatedStoryApi#list_related_stories_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
