...
# Unit tests for AylienNewsApi::TimeSeriesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TimeSeriesApi' do
  before do
  ...
  describe 'test an instance of TimeSeriesApi' do
    it 'should create an instance of TimeSeriesApi' do
      expect(@api_instance).to be_instance_of(AylienNewsApi::TimeSeriesApi)
    end
  end
