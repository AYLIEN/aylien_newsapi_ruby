...
# Unit tests for AylienNewsApi::HistogramApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'HistogramApi' do
  before do
  ...
  describe 'test an instance of HistogramApi' do
    it 'should create an instance of HistogramApi' do
      expect(@api_instance).to be_instance_of(AylienNewsApi::HistogramApi)
    end
  end
