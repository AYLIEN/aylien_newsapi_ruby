...
# Unit tests for AylienNewsApi::RelatedStoriesApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RelatedStoriesApi' do
  before do
  ...
  describe 'test an instance of RelatedStoriesApi' do
    it 'should create an instance of RelatedStoriesApi' do
      expect(@api_instance).to be_instance_of(AylienNewsApi::RelatedStoriesApi)
    end
  end
