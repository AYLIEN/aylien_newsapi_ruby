...
------------- | ------------- | -------------
[**list_trends**](TrendsApi.md#list_trends) | **GET** /trends | List trends
...
api_instance = AylienNewsApi::TrendsApi.new
...
begin
  ...
  puts "Exception when calling TrendsApi->list_trends: #{e}"
end
```
